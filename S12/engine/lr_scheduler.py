...
def one_cycle_lr(optimizer, max_lr, total_steps=None, epochs=None, steps_per_epoch=None, pct_start=0.3, div_factor=25.0,
                  final_div_factor=10000.0):
    return OneCycleLR(optimizer, max_lr, total_steps=total_steps, epochs=epochs, steps_per_epoch=steps_per_epoch,
                      pct_start=pct_start, div_factor=div_factor, final_div_factor=final_div_factor, last_epoch=-1,
                      verbose=False)
