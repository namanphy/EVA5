...
class MidasNet(BaseModel):
    ...
    def forward(self, x):
        ...
        layer_1 = self.pretrained.layer1(x)  # 256 - out
        layer_2 = self.pretrained.layer2(layer_1)  # 512 - out
        layer_3 = self.pretrained.layer3(layer_2)  # 1024 - out
        layer_4 = self.pretrained.layer4(layer_3)  # 2048 - out
